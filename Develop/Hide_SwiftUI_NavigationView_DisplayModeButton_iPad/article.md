...
**iOS 16에서는 [`NavigationSplitView`](https://developer.apple.com/documentation/swiftui/navigationsplitview)를 사용하실 경우 이 방법은 작동하지 않습니다.** `NavigationSplitView`는 `UISplitViewController`로 구현되지 않은 걸로 보이네요.
